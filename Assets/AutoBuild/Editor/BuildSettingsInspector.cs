...
public class BuildSettingsInspector : Editor {
...
//	[MenuItem("Alley Labs/Build/Settings")]
//	static void Init(){
//		provisioningFiles = FindAllProvisiongFile ();
//		keystoreFiles = FindKeyStoreFile ();
//		
...
//		
//		//_buildWindow.minSize = new Vector2(600, 800);
//		
...
//	}
	...
	void ShowAllSettings(){
		...
		//		string[] toolbarButtons = new string[]{"Development", "Production"};
		...
		//		case "Development":
		//			GUI.color =  new Color(223f/255,255f/255,167f/255,1f);
		//			ShowSettings(_buildSettingsInstance.settings,true);
		//			break;
		//		case "Production":
		//			GUI.color =  new Color(167f/255,237f/255,1,1f);
		//			ShowSettings(_buildSettingsInstance.settings,false);
		//			break;
		//		}
		if (GUI.changed) {
	...
	void DevelopmentBuild(){
		GUILayout.Space (10);
		EditorGUILayout.BeginHorizontal ();
		if (GUILayout.Button("Build IOS",GUILayout.MinHeight(50))) {		
		}
		GUILayout.Space (20);
		if (GUILayout.Button("Build Android",GUILayout.MinHeight(50))) {		
		}
		EditorGUILayout.EndHorizontal ();
	}
